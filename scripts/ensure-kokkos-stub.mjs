...
// variant's path. This writes a throwing stub for any variant whose real
// module (built by cpp/build.py) is absent.
...
for (const { file, buildCommand } of [
  ...
  writeFileSync(
    target,
    `// ${STUB_MARKER} — placeholder emitted by scripts/ensure-kokkos-stub.mjs.
